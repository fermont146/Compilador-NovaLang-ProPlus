...
import ALexico.Visuales.interfaz;
...
public VerTokens(java.awt.Frame parent, boolean modal) {
    ...
    public VerTokens(java.awt.Frame parent, boolean modal, String dirNuevo, interfaz gui) {
        super(parent, modal);
        initComponents();
        this.setTitle("Ver tokens");
        ...
        try {
            gui.Guardar();
            Process p = Runtime.getRuntime().exec("C:/Users/Juanc/Documents/NetBeansProjects/Analizador lexico/Proyecto1.exe " + dirNuevo);
            p.waitFor();
